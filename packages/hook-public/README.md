...
Ten of the eleven hooks are derived from [hooks-ts](https://github.com/michal-worwag/hooks-ts)
(`hooks-ts@0.12.0`, MIT © 2024 Michał Worwąg): `use-debounce`, `use-media-query`,
`use-copy-to-clipboard`, `use-isomorphic-layout-effect`, `use-boolean`, `use-counter`,
`use-toggle`, `use-countdown`, `use-timeout` and `use-previous`. Each of those source files
