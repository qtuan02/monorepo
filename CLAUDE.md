...
bun run e2e                      # Playwright over every app with an `e2e` task — both Templates, portfolio, documents, mcp-weather; each webServer builds and serves itself
