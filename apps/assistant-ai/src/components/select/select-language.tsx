...
export function SelectLanguage({ triggerClassName }: SelectLanguageProps) {
  ...
  return (
    ...
    >
      {/* An accessible name of its own: this app renders a second combobox on
          the chat screen (the model selector), so "the combobox" is no longer
          unambiguous for a screen reader or for a test. */}
      <SelectTrigger
