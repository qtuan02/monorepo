...
export default defineConfig({
  ...
  use: {
    baseURL: BASE_URL,
    // No i18n in this app (see README) — Chromium's default en-US locale is
    // the same language every hardcoded copy string is written in, so unlike
    // a Template clone this needs no locale pin.
