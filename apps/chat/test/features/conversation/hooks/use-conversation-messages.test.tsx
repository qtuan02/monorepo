...
// Two pages: the newest-fetched page first (as the API returns it,
// newest-message-first within the page too), then an older page fetched by a
// second `fetchNextPage()` call.
const NEWEST_PAGE = {
  items: [
    {
      id: "m3",
