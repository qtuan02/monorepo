...
export default function FooterTemplate() {
  return (
    ...
    <footer className="border-border bg-card mt-auto border-t">
      ...
      <div className="container mx-auto flex flex-col items-center gap-1 px-4 py-2 text-xs sm:h-9 sm:flex-row sm:justify-between sm:gap-4 sm:py-0 sm:px-6 lg:px-8">
        <FooterCopyright />
        <FooterBuildInfo />
      </div>
    </footer>
