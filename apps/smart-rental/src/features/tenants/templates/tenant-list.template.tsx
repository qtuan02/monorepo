...
function countByStatus(tenants: Tenant[], status?: TenantStatus) {
  return status
...
/**
 * "Quản lý khách thuê": KPI tiles over the scoped list, then the list
 * composite with a card/table view on the URL. "Thêm khách" goes to the
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <ErrorPanel
          description="Không tải được danh sách khách thuê."
        ...
        <>
          ...
          <Tabs value={view} onValueChange={(value) => setView(value as View)}>
            <DataTable
              ...
              search={{ columnId: "name", placeholder: "Tìm tên khách..." }}
              facets={[
                {
                  columnId: "status",
                  title: "Trạng thái",
              ...
              resultLabel={(count) => `${count} khách thuê được tìm thấy`}
              viewSwitch={
