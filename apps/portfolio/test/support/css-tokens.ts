 ...
 * with them; `test/features/home/components/open-graph-card.test.tsx` checks
 * the share card's literals against the same declarations, because Satori
 * cannot read a custom property and the card has to spell each colour out.
 */
