...
export const DATA = {
  ...
  about: {
    ...
    data: [
      ...
      "I am always proactive in learning and staying up to date with the latest technology trends to continuously improve both product quality and my own skills. Outside of work, I enjoy reading tech books, playing sports, and traveling to explore new places. I believe that maintaining a healthy work-life balance is essential for sustaining creativity and productivity in my career.",
    ],
  },
  work: {
