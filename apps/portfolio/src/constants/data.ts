  ...
  work: {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Worked on developing and maintaining multiple company and client projects, specializing in F&B management systems. Focused on key areas such as master data management, customer management, food item and group management, inventory control, and order processing. Built and optimized admin dashboards and management interfaces using Radix UI, Shadcn UI, Ant Design, and TanStack Table, while integrating APIs and improving state management with Zustand and TanStack Query to enhance performance and scalability. Contributed to core company systems, including sales channel management, warehouse management, and order processing, collaborating with the team to refine system design, boost performance, and deliver an improved user experience.",
      },
      {
        logoUrl: "/wisdom.jpg",
        ...
        description:
          "Developed a comprehensive vehicle maintenance management system to help mechanical engineers streamline repair and maintenance processes. The platform enables efficient tracking of vehicle services, management of repair schedules, and monitoring of maintenance history. Responsibilities included designing and prototyping the user interface using Figma, implementing the frontend with Next.js, and building the backend using Express.js and PostgreSQL. Redux.js was used for state management to ensure a responsive and seamless user experience.",
      },
    ],
  },
  education: {
